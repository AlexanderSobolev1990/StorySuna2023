...
\usepackage{pgfornament} % Современный аналог
...
\newcommand\MyVarAuthorName{А.\thinspace А.\thinspace Соболев}
\newcommand\MyVarAuthorNameSec{Соболев\thinspace А.\thinspace А.}
...
\newcommand{\vepsianrose}{%
	\AddToShipoutPictureFG*{%
		\begin{tikzpicture}[remember picture, overlay]
			\node[anchor=south east, inner sep=0pt, shift={(-1.95cm,-160.25pt)}] at (current page.north east){%
...
%			\includegraphics[scale=0.12]{vepsrosedr}% Темно-красный
	...
	\begin{figure}[h!]
		\vspace*{-77mm}
%		\hspace*{8.15cm}\phantom{\includegraphics[scale=0.12]{vepsroser}} % Красный
%		\hspace*{8.15cm}\phantom{\includegraphics[scale=0.12]{vepsrosedr}} % Темно-красный
		\hspace*{8.15cm}\phantom{\includegraphics[scale=0.12]{__rose_black}} % Черный
	\end{figure}
	\vspace*{4.0cm}
}
...
%\newcommand{\myldots}{\unskip…}
\newcommand{\myldots}{\ifhmode\unskip\fi\mbox{...}}
\newcommand{\quldots}{\ifhmode\unskip\fi\mbox{?..}}
\newcommand{\exldots}{\ifhmode\unskip\fi\mbox{!..}}
\newcommand{\exldotsit}{\ifhmode\unskip\fi\mbox{\textit{!..}}}
...
%\makeatletter
%\AtBeginDocument{%
%	\bibpunct{[}{)]}{); }{a}{(\kern-\fontdimen2\font}{,}%
%	\let\cite\citep
%}
%\makeatother

\let\cite\citep
\setlength{\bibhang}{2.3em}
%\setlength{\bibsep}{1.0\baselineskip}
\setlength{\bibsep}{0.93\baselineskip}
...
%\begin{figure}[t]
%	\centering
%	\includegraphics[width=1.0\textwidth]{pinebranch}	
%\end{figure}
...
\noindent
\includegraphics[width=0.75\textwidth]{pine_branch_transparent_3}
...
\noindent
\includegraphics[width=0.99\textwidth]{naturmort8}
...
\setlength{\cftaftertoctitleskip}{9mm}
...
%\hfill
%\includegraphics[scale=0.2]{prolog1}
\AddToShipoutPictureFG*{%
	\begin{tikzpicture}[remember picture, overlay]
...
%\input{суна2023/тест.tex} % Дорога домой
%\input{суна2023/тест2.tex} % Дорога домой
...
%\bibliographystyle{abbrvnatrussian}
